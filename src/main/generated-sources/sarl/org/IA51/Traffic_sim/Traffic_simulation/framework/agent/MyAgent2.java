...
public class MyAgent2 extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    InputOutput.<String>println("MyAgent2 spawned");
    InputOutput.<String>println("---DESTROY---");
    DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
    Destroy _destroy = new Destroy();
    _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_destroy);
  }
  
  @SyntheticMember
  private void $behaviorUnit$Destroy$1(final Destroy occurrence) {
    InputOutput.<String>println("My Agent destroyed");
  ...
  @SyntheticMember
  @Pure
  @Inline(value = "$castSkill(Time.class, ($0$CAPACITY_USE$IO_SARL_CORE_TIME == null || $0$CAPACITY_USE$IO_SARL_CORE_TIME.get() == null) ? ($0$CAPACITY_USE$IO_SARL_CORE_TIME = $0$getSkill(Time.class)) : $0$CAPACITY_USE$IO_SARL_CORE_TIME)", imported = Time.class)
  ...
  @SyntheticMember
  public MyAgent2(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public MyAgent2(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public MyAgent2(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
