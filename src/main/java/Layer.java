...
public class Layer extends Application {
	...
	public void start(Stage primaryStage) {
		...
		fileChooser.setTitle(Locale.getString(Layer.class, "OPEN_WINDOW_TITLE")); //$NON-NLS-1$
		...
		if (shapeFiles != null && !shapeFiles.isEmpty()) {
			...
			final String mouseLocationPattern = Locale.getString(Layer.class, "MOUSE_POSITION"); //$NON-NLS-1$
			...
			primaryStage.setTitle(Locale.getString(Layer.class, "WINDOW_TITLE", filename.toString())); //$NON-NLS-1$
